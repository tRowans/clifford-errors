...
#THIS IS EXACTLY THE SAME AS RHOMBIC1 EXCEPT FOR 1 LINE IN FACE TO BASE VERTEX
#(sum(coord)%2 = 0 instead of sum(coord)%2 = 1)
#CAN COMBINE THESE IF/WHEN I PUT ALL THREE TOGETHER
